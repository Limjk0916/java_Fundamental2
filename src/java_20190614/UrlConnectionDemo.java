...
public static void main(String[] args) throws IOException {
		...
		System.out.println("Serever : "+server);
		System.out.println("Cache-Control : "+cacheControl);
		System.out.println("Exprise : "+exprise);
