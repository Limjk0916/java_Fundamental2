...
public class Calendar {
	...
	//윤년인지 아닌지 판단하는 메서드 매개변수가 윤년이면 true, 아니면 false
	...
	//1년 1월 1일부터 ~ 년 월 일의 총 일수를 구하는 메서드
	public int getCount(int year, int month, int day){
		//총일수 구할 때는 년도는 이전년도까지 일수를 구해야하기 때문에 preYear 변수를 설정
		int preYear = year - 1;
	...
	public void print(int year) {
		...
		System.out.println(year+"년 달력 입니다.");
		for(int i=1;i<=12;i++){
			print(year,i);
