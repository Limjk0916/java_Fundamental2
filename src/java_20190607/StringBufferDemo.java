...
public class StringBufferDemo {
	public static void main(String[] args) {
		...
		//StringBuffer 클래스는 Object의 toString() 메서드를 오버라이딩했기 때문에 StringBuffer 클래스의 문자열이 출력됨
		//s1 뒤에 .toString()이 생략되어 있다.
